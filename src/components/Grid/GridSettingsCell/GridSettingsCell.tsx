...
import "./GridSettingsCell.scss";
import { CheckboxChangeEvent } from "antd/lib/checkbox";
import QGridMenu from "../GridMenu/GridMenu";

export interface QGridSettingsCellProps {
  expanded: boolean;
...
class QGridSettingsCell extends React.Component<QGridSettingsCellProps> {
  /**
      ...
      <>
        {!isRowSelectionEnabled ? (
          <span
            ...
            className="Q-grid-settings-cell__icon"
          ...
          >
            <svg
              className="Q-grid-settings-cell__icon--expanded"
              width="22"
              height="6"
              viewBox="0 0 22 6"
              fill="#000000"
        ...
        {!isRowSelectionEnabled ? (
          ...
          >
            ...
            this.props.settingsTriDotDropDownItems.length > 0 ? (
              ...
              >
                <svg
                  className="Q-grid-settings-cell__icon--non-expanded"
                  width="22"
                  height="6"
                  viewBox="0 0 22 6"
                  fill="none"
  ...
  render() {
    ...
    return (
      <span
        className="Q-grid-settings-cell"
...
export default QGridSettingsCell;
