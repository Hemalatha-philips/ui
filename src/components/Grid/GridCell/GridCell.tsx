...
export interface QGridCellProps {
  dataRow: any;
  dataKey: string;
  className?: string;
  showToolTip?: boolean;
...
class QGridCell extends React.Component<QGridCellProps> {
  /**
  ...
  render() {
		...
		console.log("data cell " , this.props.dataRow , this.props.dataKey)
    const {
      dataRow,
      dataKey,
      className,
          ...
          <>
            {!showToolTip ? (
              <span
                ...
                className={`Q-grid-cell ${
                  className ? `Q-grid-cell--${className}` : ``
                }`}
              >
                {formatter ? (
                  <>
                    {" "}
                    <span className="Q-grid-cell__cell-formatter">
                      {formatter}
                    </span>{" "}
              ...
              <Tooltip
                overlayClassName="Q-grid-cell__tooltip"
