...
import "./GridDateFilter.scss";

const { Option } = Select;
const { RangePicker } = DatePicker;

class QGridDateFilter extends React.Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
      selected: [],
  ...
  renderOptions() {
    return (
      <div className="Q-grid-date-filter__content__filters">
        <div>
          <Select
            ...
            className="Q-grid-date-filter__content__filters__select"
        ...
        <div className="Q-grid-date-filter__content__filters__inputs">
          <span className="Q-grid-date-filter__content__filters__inputs__title">
            Filter By Date
          </span>
          <div>
            <Space direction="vertical">
              {this.state.flag ? (
                <RangePicker
                  className="Q-grid-date-filter__content__filters__inputs__range-picker"
                ...
                <DatePicker
                  className="Q-grid-date-filter__content__filters__inputs__date-picker"
  ...
  renderButtons() {
    return (
      <div className="Q-grid-date-filter__content__action">
        <Button
          className="Q-grid-date-filter__content__action__btn Q-grid-date-filter__content__action__btn--clear "
          onClick={e => this.onReset()}
        >
          Clear
        </Button>
        <Button
          className="Q-grid-date-filter__content__action__btn Q-grid-date-filter__content__action__btn--apply"
  ...
  render() {
    return (
      <div className="Q-grid-date-filter">
        <div className="Q-grid-date-filter__header">
          Filters
          <svg
        ...
        <div className="Q-grid-date-filter__content">
          {this.renderOptions()}
          {this.renderButtons()}
        </div>
      </div>
...
export default QGridDateFilter;
