/**
 * Component for reusble grid in Q project
 * @author Deepak_T
 * @version 1.0.0
 *
...
import { tooltipData } from "../../mocks/data/tooltip.data";
//data models imports
import { Column, Grid, GridMenu } from "../../models/grid.model";
import QGridCell from "./GridCell/GridCell";
import QGridDateFilter from "./GridDateFilter/GridDateFilter";
import QGridFilterDropDown from "./GridFilterDropDown/GridFilterDropdown";
import QGridFilterIcon from "./GridFilterIcon/GridFilterIcon";
import QGridHeaderCell from "./GridHeaderCell/GridHeaderCell";
import QGridIntellisenseFilter from "./GridIntellisenseFilter/GridIntellisenseFilter";
import QGridPagination from "./GridPagination/GridPagination";
import QGridSettingsCell from "./GridSettingsCell/GridSettingsCell";
import QGridSettingsDrawer from "./GridSettingsDrawer/GridSettingsDrawer";
import QGridSettingsHeaderCell from "./GridSettingsHeaderCell/GridSettingsheaderCell";
...
interface QGridProps<T> extends Grid<T> {
  handleCheck?: any;
}
interface QGridState<T> {
  filteredInfo: null;
  filterTable: T[];
  sortedTable: T[];
...
class QFormularyGrid extends Component<QGridProps<any>, QGridState<any>> {
  state: QGridState<any> = {
    filteredInfo: null,
    filterTable: [],
    sortedTable: [],
    isMultiSort: false,
  ...
  initializeColumns = () => {
    ...
    const gridWidth =
      this.gridRef && this.gridRef.current
        ...
        : DEFAULT_GRID_WIDTH;
    console.log("width of grid ", gridWidth, requiredColumns);
  ...
  dragProps = {
    ...
    nodeSelector: "th",
    handleSelector: ".Q-grid-header-cell--dragHandler",
  ...
  onCellClick = (
    ...
    this.setState((prevState: QGridState<any>) => {
      return {
        ...prevState,
        openDialogOnClickingCell: {
  ...
  withDataToolTip = (WrappedComponent: any, data: any) => {
    ...
    return (
      <WrappedComponent
        tooltipMock1={tooltipData}
        tooltipMock2={tooltipData}
        tooltipMock3={tooltipData}
        data={data}
      />
    );
  };
  ...
  console.log(" Data " ,data.slice(from - 1, toData) )
  ...
  */
  ...
  onGetSuggestionsForColumnIntellisenseFilter = (
    ...
    key: string
		...
		console.log(" inputText " , key , inputText , this.props.data)
  ...
  */
  ...
  updateMultisortOrder = (c: Column<any>) => {
    ...
    return (
      <span className="Q-grid__multisort-order">
        {multisortOrder > 0 ? (
  ...
  */
  ...
  renderExpanderIcon = (props) => {
    ...
    if (props.expanded)
      return (
        <span
          className="Q-grid__grid-block__table-block__expand-icon Q-grid__grid-block__table-block__expand-icon--close"
      ...
      return (
        <span
          className="Q-grid__grid-block__table-block__expand-icon Q-grid__grid-block__table-block__expand-icon--open"
          style={{ cursor: "pointer" }}
  ...
  render() {
    ...
    return (
      <>
        ...
        <div ref={this.gridRef} className="Q-grid">
          {/* DRAWER  */}
          ...
          <div className="Q-grid__meta-block">
            <h3 className="Q-grid__meta-block__heading">
              {/* NAME OF GRID */}
            </h3>
            {/* BUTTON */}
          </div>

          <div className="Q-grid__grid-block">
            {/* PAGINATION */}
            ...
            <ReactDragListView.DragColumn {...this.dragProps}>
              ...
              <Table
                //   size="small"
                className="Q-grid__grid-block__table-block"
