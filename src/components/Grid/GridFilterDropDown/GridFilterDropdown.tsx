...
class QGridFilterDropDown extends React.Component<any, any> {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        this.state.optionValue !== "does not exist" ? (
          <div className="Q-grid-filter-dropdown__filter-block__value-block">
            <span className="Q-grid-filter-dropdown__filter-block__value-block__label">
              Filter by value
            </span>
            <div>
              <Input
                className="Q-grid-filter-dropdown__filter-block__value-block__input"
  ...
  render() {
    return (
      <div className="Q-grid-filter-dropdown">
        <div className="Q-grid-filter-dropdown__filters">
          Filters
          <svg
            width="19"
            height="19"
            ...
            className="Q-grid-filter-dropdown__filters__close-icon"
          >
            <path
        ...
        <div className="Q-grid-filter-dropdown__filter-block">
          {this.renderOptions()}
          {this.renderButtons()}
        </div>
      </div>
...
export default QGridFilterDropDown;
